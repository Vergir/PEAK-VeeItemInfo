...
/// item's picture and name under it - what a player sees before installing.
///
...
/// there exactly as they are in the game. A tinted sprite is recoloured with an SVG filter
/// rather than a CSS mask: browsers refuse a cross-origin image as a mask unless the host
/// opts in, and the icon vanished with it, while a filter never reads the pixels back and is
/// allowed on any image.
/// </summary>
